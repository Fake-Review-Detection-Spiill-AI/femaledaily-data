...
def main(): 
    ...
    for count in range(1, 142):
        headers = {
        'key': 'client03-hsjuebbbjasqqqivAAAbr-XkQQjannesQBlob',
        'version': '1.5',
        'device': '3',
        'endpoint': f'https://api.femaledaily.com/app/v1/reviews?product_id=18618&age_range_ids=&skin_type_ids=&skin_tone_ids=&skin_undertone_ids=&hair_texture_ids=&hair_type_ids=&sort=newest&limit=10&page={count+1}',
